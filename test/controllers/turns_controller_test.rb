...
class TurnsControllerTest < ActionController::TestCase
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post :create, turn: { day: @turn.day, horain: @turn.horain, horater: @turn.horater, state: @turn.state }
    end
  ...
  test "should update turn" do
    patch :update, id: @turn, turn: { day: @turn.day, horain: @turn.horain, horater: @turn.horater, state: @turn.state }
    assert_redirected_to turn_path(assigns(:turn))
  end
